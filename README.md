...
```bash
uvx --from git+https://github.com/elliottophellia/Ryuumonbuchi@v0.1.0 ryuumonbuchi
```
...
```json
{
  "mcpServers": {
    "ryuumonbuchi": {
      ...
      "args": [
        "--from",
        "git+https://github.com/elliottophellia/Ryuumonbuchi@v0.1.0",
        "ryuumonbuchi"
      ],
      "env": {
...
- Programs: import, delete, list, and information
- Inspection: functions, listing, memory, symbols, strings, references, graphs, and searches
- Analysis: auto-analysis and analysis options
- Editing: names, comments, prototypes, byte patches, undo, and redo
...
Defaults are 1024 MiB heap, two CPU cores, 15-minute operation timeout, 4 MiB response size, and a 64 KiB failure-log tail. Requests have bounded pages, reads, patches, patterns, graphs, decompilation, scans, and batches.
